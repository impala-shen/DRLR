...
from algorithms.IBRL import IBRL,IBRL_DEFAULT_CONFIG
...
# ============================================================================
memory = RandomMemory(memory_size=350000, num_envs=env.num_envs, device=device, replacement=True)
...
agent_IBRL = IBRL(models=models_td3,
                models_il=models_BC,
                memory=memory,
