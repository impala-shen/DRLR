...
from algorithms.BC import BC,BC_DEFAULT_CONFIG
...
expert_memory = RandomMemory(memory_size=20000, num_envs=env.num_envs, device=device, replacement=False)

# # instantiate the agent's models, Behavior clone (BC) requires 1 model to learn the expert behavior
models_BC = {}
models_BC["policy"] = BCmodel(env.observation_space, env.action_space, device, clip_actions=True)
