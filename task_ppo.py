...
expert_memory = RandomMemory(memory_size=5000, num_envs=env.num_envs, device=device, replacement=False)
...
models_ppo["value"] = Shared(env.observation_space, env.action_space, device)  # same instance: shared model
